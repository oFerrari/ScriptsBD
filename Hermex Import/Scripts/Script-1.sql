...
SELECT
    ID,
    DATE("Data do Pedido") AS 'Data do Pedido',
    Status,
    "Total do Pedido",
    Cliente,
    DATE("Data de Envio Estimada") AS 'Data de Envio Estimada'
...
SELECT
    ID,
    strftime('%Y-%m-%d', "Data do Pedido") AS 'Data do Pedido',
    Status,
    "Total do Pedido",
    Cliente,
    strftime('%Y-%m-%d', "Data de Envio Estimada") AS 'Data de Envio Estimada'
FROM tabela_pedidos_old;


select * from tabela_pedidos_old tp 
